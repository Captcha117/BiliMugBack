...
- Eclipse、IDEA运行BiliMugApplication.java，则可启动项目
- Swagger文档路径：http://localhost:8080/bili-mug/swagger/index.html
- Swagger注解路径：http://localhost:8080/bili-mug/swagger-ui.html
